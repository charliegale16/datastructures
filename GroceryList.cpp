...
void GroceryList::insert(const GroceryItem& item, std::size_t offsetFromTop)       // insert new item at offsetFromTop, which places it before the current item at offsetFromTop
{
    ...
    /**********  Insert into array  ***********************/
    {
        ...
        std::move_backward(_groceries_array.begin() + offsetFromTop,// start of range
                      _groceries_array.begin() + _groceries_array_size,
                      _groceries_array.begin() + _groceries_array_size + 1);
        
        
        _groceries_array[offsetFromTop] = item;
    ...
    /**********  Insert into vector  **********************/
    {
        ...
        _groceries_vector.insert(_groceries_vector.begin() + offsetFromTop, item);
    ...
    /**********  Insert into singly linked list  **********/
    {
        ...
        _groceries_sl_list.insert_after(std::next(_groceries_sl_list.before_begin(),offsetFromTop), item);
...
void GroceryList::remove(std::size_t offsetFromTop)
{
    ...
    /**********  Remove from singly linked list  **********/
    {
        ...
        _groceries_sl_list.erase_after(std::next(_groceries_sl_list.before_begin(),offsetFromTop));
